...
<table>
  <tr>
    <th>Seat Type</th>
    <th>Seat Code</th>
    <th>Mon and Wed AND 12pm on weekdays</th>
   ...
   <fieldset>
        <legend>Standard</legend>
          <p>
              ...
              <input type="number" id="stdConcession" Adult="stdConcesssion" />
             ...
             <input type="text" id="email" name="customerEmail" />
              ...
              <input type="number" id="stdChildren" Adult="stdChildren" />
             
             &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
              <label for="mobile">Mobile:</label>
            <input type="tel" id="customerMobile" name="customerMobile" />
            <p>
     ...
     <fieldset>
          ...
          <p>
              ...
              <input type="number" id="firstdAdult" Adult="firstAdult" />
               <p>
                <label for="Concession">Concession</label>
              <input type="number" id="firstConcession" Adult="firstConcesssion" />
               <p>
              <label for="Children">Children</label>
